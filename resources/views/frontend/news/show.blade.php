                    ...
                    <div class="dz-info">
                        ...
                        <div class="dz-share-post mt-4">
                            ...
                            <ul class="dz-social-icon">
                                ...
                                <li>
                                    <a
                                        href="https://twitter.com/intent/tweet?url={{ urlencode($newsUrl) }}&text={{ urlencode($news->title) }}"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                ...
                                <li>
                                    <a
                                        href="https://wa.me/?text={{ urlencode($news->title . ' ' . $newsUrl) }}"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                ...
                                <li>
                                    <a
                                        href="mailto:?subject={{ urlencode($news->title) }}&body={{ urlencode($newsUrl) }}"
