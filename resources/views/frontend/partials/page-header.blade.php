            ...
            <div class="dz-topbar-inner d-flex justify-content-between align-items-center">
                ...
                <div class="dz-topbar-left">
                    <ul class="dz-social-icon">
                        ...
                        @if (setting('facebook'))
                            <li>
                                <a class="fab fa-facebook-f" href="{{ setting('facebook') }}" target="_blank">
                                </a>
                            </li>
                        @endif
                        ...
                        @if (setting('instagram'))
                            <li>
                                <a class="fab fa-instagram" href="{{ setting('instagram') }}" target="_blank">
                                </a>
                            </li>
                        @endif
                        ...
                        @if (setting('twitter'))
                            <li>
                                <a class="fab fa-twitter" href="{{ setting('twitter') }}" target="_blank">
                                </a>
                            </li>
                        @endif
                        ...
                        @if (setting('youtube'))
                            <li>
                                <a class="fab fa-youtube" href="{{ setting('youtube') }}" target="_blank">
                                </a>
                            </li>
                        @endif
        ...
        <div class="main-bar clearfix ">
            <div class="container-fluid clearfix">
                ...
                <div class="logo-header mostion logo-dark">
                    <a href="{{ url('/') }}">
                        <img src="{{ setting_asset(setting('logo'), 'frontend/images/logo.png') }}"
                ...
                <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                    ...
                    <div class="dz-social-icon">
                        <ul>
                            <li><a class="fab fa-facebook-f" href="javascript:;"></a></li>
                            <li><a class="fab fa-twitter" href="javascript:;"></a></li>
                            <li><a class="fab fa-linkedin-in" href="javascript:;"></a></li>
                            <li><a class="fab fa-instagram" href="javascript:;"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
