...
@section("auth-content")
   <aside class="auth-brand-panel">
        ...
        <a href="{{ route('index') }}" class="auth-logo">
            <img
                src="{{ asset('frontend/images/logo-white.jpg') }}"
                alt="FutureMap Media">
        ...
        <div class="auth-brand-card">
            ...
            <div>
                ...
                <span>
                    Password reset links are securely delivered to your registered
                    email address.
                </span>
            </div>
        </div>
            ...
            <div class="auth-card">
                ...
                <div class="auth-card-header">
                    ...
                    <p class="auth-subtitle">
                        Enter the email address associated with your FutureMap Media
                ...
                <div class="auth-note-panel">
                    ...
                    <span>
                        The password reset link will be sent only to the email address
