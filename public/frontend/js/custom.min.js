var FmapMedia = (function () {
                ...
                .on("click", function (e) {
                    if ((e.preventDefault(), "" !== this.hash)) {
                        ...
                        $("body").scrollspy({ target: ".navbar", offset: i + 2 }),
                            $("html, body").animate({ scrollTop: t - i }, 800, function () {});
                    }
                }),
    ...
    (monthNames = [
        ...
        (p = p.getDate() + " " + monthNames[p.getMonth()] + " " + p.getFullYear());
    var h = function () {
        ...
        y = function () {
            ...
            jQuery("a").on("mousemove", function (e) {
                ...
                ((s) => {
                    ...
                    window.trace = c;
                    let d = (e) => {
                            let t = { pointerColor: "#750c7e", ringSize: 15, ringClickSize: (s.ringSize || 15) - 5 };
                            return void 0 == s[e] ? t[e] : s[e];
                        },
                        u = () => {
                            void 0 != i &&
                                ((o = c(o, i, 0.2)),
                                (a = c(a, n, 0.2)),
                                document.querySelector(".p-action-click:hover")
                                    ? ((e.style.borderColor = d("pointerColor")), (r = !0))
                                    : ((e.style.borderColor = "white"), (r = !1)),
                                (t.style.borderColor = d("pointerColor")),
                                l
                                    ? (t.style.padding = d("ringClickSize") + "px")
                                    : (t.style.padding = d("ringSize") + "px"),
