            ...
            if (!i.isTouchEvent || "touchmove" === o.type) {
                ...
                if (!a.allowTouchMove)
                    return (
                        ...
                        void (
                            i.isTouched &&
                            (S(n, { startX: p, startY: c, currentX: p, currentY: c }), (i.touchStartTime = x()))
                        )
                    );
            ...
            update: {
                ...
                updateSlides: function () {
                    ...
                    if (void 0 !== n) {
                        ...
                        for (
                            var P, k, L, $ = s.slidesPerColumn, I = M / $, O = Math.floor(h / s.slidesPerColumn), A = 0;
                            A < h;
                            A += 1
                        ) {
                            z = 0;
                ...
                translateTo: function (e, t, a, i, s) {
                    ...
                    if (((o = i && e > d ? d : i && e < p ? p : e), r.updateProgress(o), n.cssMode)) {
                        ...
                        if (0 === t) l[u ? "scrollLeft" : "scrollTop"] = -o;
                            ...
                            l.scrollTo((((c = {})[u ? "left" : "top"] = -o), (c.behavior = "smooth"), c));
                ...
                slideTo: function (e, t, a, i) {
                    ...
                    if (l.cssMode) {
                        ...
                        if ((u && (C = h.scrollWidth - h.offsetWidth - C), 0 === t))
                            ...
                            h.scrollTo((((x = {})[T ? "left" : "top"] = C), (x.behavior = "smooth"), x));
            ...
            setTranslate: function () {
                ...
                for (var v = 0; v < s.length; v += 1) {
                    ...
                    var C =
                        ...
                        "px)";
                    if (
                        (y <= 1 && y > -1 && ((h = 90 * g + 90 * y), l && (h = 90 * -g - 90 * y)),
                        f.transform(C),
                        p.slideShadows)
                    ) {
                        ...
                        0 === S.length &&
                            ((S = m('<div class="swiper-slide-shadow-' + (c ? "left" : "top") + '"></div>')),
                            f.append(S)),
                            0 === M.length &&
