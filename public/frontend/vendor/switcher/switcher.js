...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-dark img, .site-footer .footer-logo img").attr("src", "images/logo.png");
		jQuery(".layout-dark .logo-dark img").attr("src", "images/logo-white.png");
		jQuery(".dz-coming-soon .sidenav-menu .logo img").attr("src", "images/logo-icon.png");
		
        return false;
    });
    jQuery(".skin-2").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-2.css");
		jQuery(".logo-dark img, .site-footer .footer-logo img").attr("src", "images/logo-2.png");
		jQuery(".layout-dark .logo-dark img").attr("src", "images/logo-white-2.png");
		jQuery(".dz-coming-soon .sidenav-menu .logo img").attr("src", "images/logo-icon-2.png");
        return false;
    });
   
    jQuery(".skin-3").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-3.css");
		jQuery(".logo-dark img, .site-footer .footer-logo img").attr("src", "images/logo-3.png");
		jQuery(".layout-dark .logo-dark img").attr("src", "images/logo-white-3.png");
		jQuery(".dz-coming-soon .sidenav-menu .logo img").attr("src", "images/logo-icon-3.png");
        return false;
    });
	
	jQuery(".skin-4").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-4.css");
		jQuery(".logo-dark img, .site-footer .footer-logo img").attr("src", "images/logo-4.png");
		jQuery(".layout-dark .logo-dark img").attr("src", "images/logo-white-4.png");
		jQuery(".dz-coming-soon .sidenav-menu .logo img").attr("src", "images/logo-icon-4.png");
        return false;
    });
	
	jQuery(".skin-5").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-5.css");
		jQuery(".logo-dark img, .site-footer .footer-logo img").attr("src", "images/logo-5.png");
		jQuery(".layout-dark .logo-dark img").attr("src", "images/logo-white-5.png");
		jQuery(".dz-coming-soon .sidenav-menu .logo img").attr("src", "images/logo-icon-5.png");
        return false;
    });
	
	jQuery(".skin-6").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-6.css");
		jQuery(".logo-dark img, .site-footer .footer-logo img").attr("src", "images/logo-6.png");
		jQuery(".layout-dark .logo-dark img").attr("src", "images/logo-white-6.png");
		jQuery(".dz-coming-soon .sidenav-menu .logo img").attr("src", "images/logo-icon-6.png");
        return false;
    });
	
	jQuery(".skin-7").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-7.css");
		jQuery(".logo-dark img, .site-footer .footer-logo img").attr("src", "images/logo-7.png");
		jQuery(".layout-dark .logo-dark img").attr("src", "images/logo-white-7.png");
		jQuery(".dz-coming-soon .sidenav-menu .logo img").attr("src", "images/logo-icon-7.png");
        return false;
    });
	
	jQuery(".skin-8").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-8.css");
		jQuery(".logo-dark img, .site-footer .footer-logo img").attr("src", "images/logo-8.png");
		jQuery(".layout-dark .logo-dark img").attr("src", "images/logo-white-8.png");
		jQuery(".dz-coming-soon .sidenav-menu .logo img").attr("src", "images/logo-icon-8.png");
        return false;
    });
...
function setThemePanel(){
	...
	if(logoValue != '')
	{
		...
		jQuery(".logo-dark a img, .site-footer .footer-logo img, .layout-dark .logo-dark img").attr("src", logoValue);
	} 
}
...
function setThemeLogo(themeOptionItemAttr){
	...
	if(logo != ''){
		...
		jQuery(".logo-dark img, .site-footer .footer-logo img, .layout-dark .logo-dark img").attr("src", logo);
